...
## CHANGE THESE VALUES
APPID = os.environ.get('DEEZER_CLIENT_ID', '647181')
SECRET = os.environ.get('DEEZER_CLIENT_SECRET', '6210f5411f88ed6d35f84ecc7f61a109')
USER_ID = os.environ.get('DEEZER_USER_ID', '2401568324')
